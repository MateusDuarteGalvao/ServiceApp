...
public class HomeActivityDrawer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.menu_config:{
                Intent config = new Intent(HomeActivityDrawer.this, ConfiguracoesClienteActivity.class);
    ...
    private void abrirConfiguracoes() {
        startActivity(new Intent(HomeActivityDrawer.this, ConfiguracoesClienteActivity.class));
    }
